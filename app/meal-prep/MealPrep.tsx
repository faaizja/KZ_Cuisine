...
const menuItems = [
  ...
  {
   id: "8",
    name: "Malai Boti Rice Platter",
    description: "Pulao with boneless grilled chicken) with Raita (Green chatni yogurt) & Salad",
    price: 14.99,
    category: "Main Menu",
  ...
  {
   id: "9",
    name: "Grilled Veal Tikka Platter",
    description: "Veal skewers with 2 Naan with Raita (Green chatni yogurt) & Salad",
    price: 14.99,
    category: "Main Menu",
    image: "/veal-tikka.jpeg", 
  },
  {
   id: "10",
    name: "Grilled Veal Tikka Rice Platter",
    description: "Pulao with Veal tikka Skewers on top with Raita (Green chatni yogurt) & Salad",
    price: 14.99,
    category: "Main Menu",
    image: "/veal-tikka.jpeg", 
  }
  ...
  return (
    <main className="container mx-auto px-4 py-12 md:py-20 min-h-screen">
      <div className="text-center mb-12 md:mb-20">
        ...
        <span className="text-accent">MEAL PREP MENU</span>
        </h1>
